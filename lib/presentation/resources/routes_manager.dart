...
class RouteGenerator{
  ...
  static Route<dynamic> unDefinedRoute() {
    return MaterialPageRoute(builder: (_) =>
      Scaffold(
        appBar: AppBar(title: const Text("No route found"),), // todo move this string to string manager
        body: const Center(child: Text("No route found")), // todo move this string to string manager
      ),
    );
  }
}